          ...
          <div className="md:flex md:space-x-12 space-y-8 md:space-y-0">
            ...
            <div className="w-full md:w-1/2 space-y-8">
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Comment puis-je régler les logements ?</summary>
              ...
              {/* Item */}
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Où se situent les logements ?</summary>
              ...
              {/* Item */}
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Je viens en transports en commun, vais-je devoir marcher longtemps ?</summary>
              ...
              {/* Item */}
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">J'arrive, tard, tôt, dans la nuit, quelqu'un pourra-t-il m'ouvrir ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Vos logements ont-ils le wifi ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Disposez-vous d'un accès PMR ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">J'arrive avec mon propre linge de maison, que dois-je prévoir ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Que se passe-t-il si j'ai oublié de régler les arrhes ou la caution avant mon arrivée ?</summary>
            ...
            <div className="w-full md:w-1/2 space-y-8">
              {/* Item */}
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Quels sont les horaires d'arrivées et de départ ?</summary>
              ...
              {/* Item */}
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Puis-je ajouter des options pendant mon séjour ?</summary>
              ...
              {/* Item */}
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Quel sont les équipements du logement ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Je dois allez voir le médecin de cure. Est-ce loin ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Combien de personnes peuvent loger dans un appartement ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Ai-je la possibilité d'avoir une facture pour ma mutuelle ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">L'arrivée est autonome, mais quand et comment me seront envoyé le code de ma boîte à clef ?</summary>
              ...
              <details className="space-y-2">
                <summary className="text-xl font-cabinet-grotesk font-bold">Où dois-je vous faire parvenir les chèques ou les virements pour le règlement du logement ?</summary>
